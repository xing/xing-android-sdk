...
/**
 * Adapter for {@linkplain GeoCode} objects. When parsing a {@linkplain GeoCode} will returns {@code null} if the
    ...
    public GeoCode fromJson(JsonReader reader) throws IOException {
        ...
        while (reader.hasNext()) {
            ...
            if ("accuracy".equals(name)) {
                ...
                throw new AssertionError("Expecting one of [accuracy, latitude, longitude], found: " + name);
            }
        }
        reader.endObject();
