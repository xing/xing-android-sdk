...
import com.xing.api.model.PictureUpload;
...
public class ProfileEditingResource extends Resource {
     ...
     * </table>
     */
    public CallSpec<String, HttpError> updateUserGeneralInformation() {
        return Resource.<String, HttpError>newPutSpec(api, "v1/users/me", true)
     ...
     */
    public CallSpec<String, HttpError> updateUsersProfilePicture(PictureUpload pictureUpload) {
        return Resource.<String, HttpError>newPutSpec(api, "v1/users/me/photo", true)
              .responseAs(String.class)
     ...
     */
    public CallSpec<String, HttpError> deleteUsersProfilePicture() {
        return Resource.<String, HttpError>newDeleteSpec(api, "v1/users/me/photo")
              .responseAs(String.class)
              .build();
    }
     ...
     */
    public CallSpec<String, HttpError> getProfilePictureUploadProgress() {
        return Resource.<String, HttpError>newGetSpec(api, "/v1/users/me/photo/progress")
              .responseAs(String.class)
              .build();
    }
     ...
     * </table>
     */
    public CallSpec<String, HttpError> updateUsersPrivateAddress() {
        return Resource.<String, HttpError>newPutSpec(api, "/v1/users/me/private_address", true)
              .responseAs(String.class)
              .build();
    }
     ...
     * </table>
     */
    public CallSpec<String, HttpError> updateUsersBusinessAddress() {
        return Resource.<String, HttpError>newPutSpec(api, "/v1/users/me/business_address", true)
              .responseAs(String.class)
              .build();
    }
     ...
     */
    public CallSpec<String, HttpError> addSchoolToUsersProfile(String name) {
        return Resource.<String, HttpError>newPostSpec(api, "/v1/users/me/educational_background/schools", true)
              .formField("name", name)
              .build();
    }
}
